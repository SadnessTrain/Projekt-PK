		...
		public void actionPerformed(ActionEvent e) {
			...
			if ((s.charAt(0) >= '0' && s.charAt(0) <= '9') || s.charAt(0) == '.') {			// je¿eli wybrany przycisk to liczba 1-9/'.'
	            if (!l1.equals(""))															// to j¹ wpisuje albo dodaje po kropce
	                ...
	                l0 = l0 + s;															// dobra naprawi³em, jednak moja wina. nie lubie kiedy to jest moja wina
	            ...
	            t.setText(l0 + l1 + l2);													// to wszystko zaczyna dzia³aæ
	        }
			else if (s.charAt(0) == '=') {
	            ...
	            if (l1.equals("") || l2.equals(""))											// nie, nie wiem dlaczego to znowu tu jest
	                l1 = s;																	// ca³y blok kodu copy-pastowany ale dzia³a
